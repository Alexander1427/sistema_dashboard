...
$sentencia = $base_de_datos->prepare("INSERT INTO venta(total_venta, estado,`idcliente`, `idusuario`,`tipo_comprobante`) VALUES (?, ?,?, ?, ?);");
$sentencia->execute([$total, $estado,$idcliente,$idusuario,$comprobante]);
