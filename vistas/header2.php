...
<head>
    ...
    <!-- vector map -->
    <link href="../assets/vendor/jquery-toast-plugin-master/dist/jquery.toast.min.css" rel="stylesheet">
    <!-- Toast message -->
    <link href="../assets/vendor/jquery-jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet">
    <!-- dataTables picker -->
    <link href="../assets/vendor/DataTables-1.10.18/css/dataTables.bootstrap4.min.css" rel="stylesheet">
...
$query="SELECT COUNT(*) as total FROM `articulo` WHERE `stock`<=5";
  ...
  <div class="nav flex-column">
      <div class="nav-item"><a class="nav-link" href="articulo.php"><span>Articulos</span></a></div>
      <div class="nav-item"><a class="nav-link" href="categoria.php"><span>Categorias</span></a></div>
  </div>
</li>';
}
        ?>
      ...
      <li class="nav-item dropdown">
          ...
          <div class="nav flex-column">
              ...
              <div class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="ingreso.php"><span>INGRESOS</span></a>
              
              </div>
              <div class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="proveedor.php"><span>PROVEEDORES</span></a>
              </div>
...
if ($_SESSION['acceso']==1) {
  ...
  <li class="nav-item dropdown">
      ...
      <div class="nav flex-column">
          <div class="nav-item"><a class="nav-link" href="comprasfecha.php"><span>Consultas por fecha</span></a></div>
...
if ($_SESSION['consultac']==1) {
  ...
  <li class="nav-item dropdown">
      ...
      <div class="nav flex-column">
      <div class="nav-item"><a class="nav-link" href="venta.php"><span>Ventas generales</span></a></div>
          <div class="nav-item"><a class="nav-link" href="cierre.php"><span>Ventas Diarias</span></a></div>
