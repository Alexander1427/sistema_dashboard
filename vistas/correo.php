...
<head>
    ...
    <link href="https://fontawesome.com/icons?d=gallery&q=laptop" rel="atylesheet">

    <script src="https://kit.fontawesome.com/341bd9bee4.js"></script>
    <!-- flags icons -->
                    ...
                    <div class="col d-none d-md-block border-left  py-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <button class="btn btn-sm btn-link" type="button" onclick="muestrate();">
                        ...
                        <div class="row mt-4" id="caja" >
                                ...
                                <div class="card mb-4 shadow-sm border-0">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <textarea name ="message" class="message"  rows="5" id="editor"></textarea>
                                    </div>
