                        ...
                        <table class="table datatable display responsive w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="">Estado</th>
                                    <th class="min-desktop">Numero</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">MK</p>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">0586333-4</p>
                                                <p class="text-template-primary-light">Numero de dui</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">2270-4818</p>
                                                <p class="text-template-primary-light">Numero de teléfono</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">mk@mk.com</p>
                                                <p class="text-template-primary-light">Correo</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <div class="media">
                                            <figure class="mb-0 avatar avatar-40 mr-2">
                                                <img src="../assets/img/logol.jpg" alt="">
                                            </figure>
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">MACRO CLEAN</p>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">0578963-5</p>
                                                <p class="text-template-primary-light">Numero de dui</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">2233-6596</p>
                                                <p class="text-template-primary-light">Numero de teléfono</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">macroclean@macro.com</p>
                                                <p class="text-template-primary-light">Correo</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr id="lim" class="animate__animated animate__bounce">
                                    <td>ID0003</td>
                                    <td>
                                        <div class="media">
                                            <figure class="mb-0 avatar avatar-40 mr-2">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">SIMÁN</p>
                                                <p class="text-template-primary-light">Accesorios</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>25-09-2020</td>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">56236-9</p>
                                                <p class="text-template-primary-light">NRF</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">2256-3389</p>
                                                <p class="text-template-primary-light">Numero de teléfono</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">simansv@siman.com.es</p>
                                                <p class="text-template-primary-light">correo</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="col-md-10 mx-auto">
                                        <div class="row ">
                                            <div class="col-lg-12 col-md-12 text-center">
                                                ...
                                                <h4 class="mt-3 mb-1">INGRESO DE PROVEEDORES</h4>
                                                <p class="text-mute">DESIT</p>
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                        <p>Por favor llena los campos para poder ingresar una proveedor</p>
                                        <br>
                                        <h5 class="m-0">DETALLES DE LA PROVEEDOR</h5>
                                        <hr>
