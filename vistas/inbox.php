                        ...
                        <div class="row  bg-white text-dark">
                            ...
                            <div class="col-11 col-xl-9 mx-auto py-5 mb-4">
                                <p>Hola  Max,
                                    ...
                                    <br>
                                    <br>Esperamos que estés muy bien deseando lo mejor para ti.<br>
                                    <br> El motivo de este mensaje es para poder contarte de que estamos ofreciéndote un plan empresarial por el uso de WhatsApp en tu sistema lo que permitirá agilizar el envió de tus datos, sin la necesidad de salir de el sistema
                                    <br>

                                </p>
                                <br>
                                <blockquote class="blockquote text-center">
                                    <p class="mb-0">Este sorprendente servicio te será entregado por la compra de tu membresía, además de incluirte diferentes beneficios como el chat empresarial.</p>
                                    <footer class="blockquote-footer mt-3">DESIT PRO Whatsapp</footer>
                                </blockquote>
                                <br>
                                <p>
                                Términos aplican un pago mensual por el uso de la aplicación que podrán mantenerse junto al pago del sistema.
                                    <br>
                                    <br> Por tu atención Gracias,
                                    <br>
                                    <br>
