                        ...
                        <table class="table datatable display responsive w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="">Estado</th>
                                    <th class="min-desktop">Comprobante</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">Factura</p>
                                                <p class="text-template-primary-light">Factura Cliente</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">0450</p>
                                                <p class="text-template-primary-light">Numero de comprobante</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">$350</p>
                                                <p class="text-template-primary-light">Total</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">0455</p>
                                                <p class="text-template-primary-light">Numero de comprobante</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">$780</p>
                                                <p class="text-template-primary-light">Total</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr id="lim" class="animate__animated animate__bounce">
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">Credito Fiscal</p>
                                                <p class="text-template-primary-light">Credito Fiscal Cliente</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">0750</p>
                                                <p class="text-template-primary-light">Numero de comprobante</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">$150</p>
                                                <p class="text-template-primary-light">Total</p>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 mx-auto">
                                        ...
                                        <br>
                                        <br>
                                        <p>Por favor llena los campos para el ingreso de productos</p>
                                        <br>
                                        <h5 class="m-0">DETALLES DE INGRESO</h5>
                                        <hr>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label>PROVEEDOR</label>
                                                        <select class="form-control " data-live-search="true" tabindex="-1" aria-hidden="true">
                                                            ...
                                                            <option value="MACRO CLEAN">MACRO CLEAN</option>
                                                        </select>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <label>FECHA</label>
