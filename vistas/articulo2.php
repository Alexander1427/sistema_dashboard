                        ...
                        <div class="row">
                            ...
                            <div class="col-auto align-self-center">
                                <button class="btn btn-success ml-2" onclick="ACTIVO()">
                                    <i class="material-icons md-18">cloud_download</i> AGREGAR PRODUCTO
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">Alcohol Gel</p>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="text-template-primary-light">categoria</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            <figure class="mb-0 avatar avatar-40 mr-2">
                                            <img src="../assets/img/ace.png" alt="">
                                            </figure>
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">Acetaminofen</p>
                                                <p class="text-template-primary-light">medicamento</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">PARACETAMOL</p>
                                                <p class="text-template-primary-light">medicamentos</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>25-09-2020</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            <figure class="mb-0 avatar avatar-40 mr-2">
                                                <img src="../assets/img/desin.jpg" alt="">
                                            </figure>
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">DESINFECTANTE</p>
                                ...
                                <tr id="jabon" class="animate__animated animate__bounce">
                                    <td>ID0005</td>
                                    <td>
                                        <div class="media">
                                            <figure class="mb-0 avatar avatar-40 mr-2">
                                            <img src="../assets/img/jabon.jpg" alt="">
                                            </figure>
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">Jabon</p>
                                                <p class="text-template-primary-light">Limpieza</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-0 template-inverse">LIMPIEZA</p>
                                                <p class="text-template-primary-light">categotia</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 mx-auto">
                                        ...
                                        <br>
                                        <br>
                                        <p>Por favor llena los campos para poder ingresar un producto</p>
                                        <br>
                                        <h5 class="m-0">DETALLES DEL PRODUCTO</h5>
                                        <hr>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="custom-dropzone text-center align-items-center" id="my-dropzone">
                                                    <div class="dz-default dz-message" data-dz-message="">
                                                        ...
                                                        <p>Arrastra la imagen de tus productos</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
