...
<div class="box-header with-border">
  <h1 class="box-title">Consulta de Ventas (Productos y Servicios)</h1>
...
<div class="panel-body table-responsive" id="listadoregistros">
  ...
  <div class="form-group col-lg-1 col-md-1 col-sm-4 col-xs-12">
    ...
    <select name="hora_inicio" id="hora_inicio" class="form-control selectpicker"  required>
  ...
  <div class="form-group col-lg-1 col-md-1 col-sm-4 col-xs-12">
    ...
    <select name="hora_fin" id="hora_fin" class="form-control selectpicker"  required>
      <option value="09:00:00">9 AM</option>
      <option value="10:00:00">10 AM</option>
      <option value="11:00:00">11 AM</option>
      <option value="12:00:00">12 MD</option>
  ...
  <div class="form-inline col-lg-# col-md-3 col-sm-4 col-xs-12">
    ...
    <select name="servicio" id="servicio" onclick="listar()" class="form-control selectpicker" data-live-search="true" required>
    </select>
    </div>
...
require 'footer.php';
 ?>
 <script src="scripts/totales3.js"></script>
 <?php 
}
